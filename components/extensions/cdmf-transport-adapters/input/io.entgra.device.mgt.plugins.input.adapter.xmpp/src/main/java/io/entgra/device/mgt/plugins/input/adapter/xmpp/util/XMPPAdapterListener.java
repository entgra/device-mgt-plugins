 ...
 * under the License.
 */
package io.entgra.device.mgt.plugins.input.adapter.xmpp.util;
...
import io.entgra.device.mgt.plugins.input.adapter.xmpp.internal.InputAdapterServiceDataHolder;
