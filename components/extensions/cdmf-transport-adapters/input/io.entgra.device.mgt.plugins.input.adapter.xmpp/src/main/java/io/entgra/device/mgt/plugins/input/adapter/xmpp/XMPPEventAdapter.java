...
* under the License.
*/
package io.entgra.device.mgt.plugins.input.adapter.xmpp;

import org.wso2.carbon.context.PrivilegedCarbonContext;
import io.entgra.device.mgt.plugins.input.adapter.xmpp.util.XMPPAdapterListener;
import io.entgra.device.mgt.plugins.input.adapter.xmpp.util.XMPPEventAdapterConstants;
import io.entgra.device.mgt.plugins.input.adapter.xmpp.util.XMPPServerConnectionConfiguration;
