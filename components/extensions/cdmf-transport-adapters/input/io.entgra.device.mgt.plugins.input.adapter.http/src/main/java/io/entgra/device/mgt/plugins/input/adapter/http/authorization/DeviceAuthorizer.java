 ...
 * under the License.
 */
package io.entgra.device.mgt.plugins.input.adapter.http.authorization;
...
import io.entgra.device.mgt.plugins.input.adapter.http.authorization.client.OAuthRequestInterceptor;
import io.entgra.device.mgt.plugins.input.adapter.http.authorization.client.dto.AuthorizationRequest;
import io.entgra.device.mgt.plugins.input.adapter.http.authorization.client.dto.DeviceAccessAuthorizationAdminService;
import io.entgra.device.mgt.plugins.input.adapter.http.authorization.client.dto.DeviceAuthorizationResult;
import io.entgra.device.mgt.plugins.input.adapter.http.authorization.client.dto.DeviceIdentifier;
