...
public interface DeviceManagementService {
    ...
    @ApiOperation(
            httpMethod = "GET",
            value = "Getting operations made for specified device",
            notes = "Use this REST API to retrieve the operation made for an Android device. If operation state " +
                    "specified this will return operations only with specified operation status",
            tags = "Android Device Management",
            extensions = {
                    @Extension(properties = {
                            @ExtensionProperty(name = AndroidConstants.SCOPE, value = "perm:android:enroll")
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    code = 200,
                    message = "OK. \n Successfully fetched operations made for the Android device.",
                    responseHeaders = {
                            @ResponseHeader(
                                    name = "Content-Type",
                                    description = "The content type of the body"),
    ...
    Response getOperations(
            ...
            @ApiParam(
                    name = "status",
                    value = "The operation status such as IN_PROGRESS, PENDING, COMPLETED, ERROR, REPEATED")
